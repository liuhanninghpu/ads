package com.matt.ads.index.adsUnitKeyword;
...
@Slf4j
@Component
public class AdsUnitKeywordIndex implements IndexAware<String, Set<Long>> {
    ...
    public void delete(String key, Set<Long> value) {
        log.info("UnitKyewordIndex,before delete :{}",unitKeywordMap);
